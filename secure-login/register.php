...
<head>
  ...
  function fSub()
  {
	document.forms[0].action = "/bv/signup?email="+document.forms[0].username.value+"&password="+document.forms[0].password.value+"&csrf_field=";
...
<div class="wrapper">
	...
	<div class="main">
		...
		<h1> <a href="register.php">Simple. Secure. Register</a> </h1>
    ...
    <?php else: ?>
    <form name="form1" class="login" action="../bv/signup" target="_parent" method="post">
      <div class="inputs">
        <p class="input-block">
      ...
      <div class="actions">
        <input type="button" class="button" id="register" value="Register" onclick="fSub()">
