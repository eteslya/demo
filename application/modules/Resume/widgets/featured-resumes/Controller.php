...
class Resume_Widget_FeaturedResumesController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
    ...
    //$this->view->widget_name = 'resume_featuredresumes_'.$this->getElement()->getIdentity().'_'.md5(mt_rand(0,32) . time());
    $this->view->widget_name = 'resume_featuredresumes_'.$this->getElement()->getIdentity();
