        ...
        <?php foreach ($this->paginator as $resume): ?>
          ...
          <li>
            ...
            <div class="resume_content">
              ...
              <div class="resume_description v_i_m">
              ...
              <div class="resume_options">
                <?php if ($resume->authorization()->isAllowed($this->viewer(), 'edit')): ?>
                  <?php echo $this->htmlLink(array('route'=>'resume_specific', 'action'=>'edit', 'resume_id'=>$resume->getIdentity()), $this->translate('Edit Resume'), array('class'=>'buttonlink icon_resume_edit'))?>
                <?php endif; ?>
                <?php if ($resume->authorization()->isAllowed($this->viewer(), 'delete')): ?>
                  <?php echo $this->htmlLink(array('route'=>'resume_specific', 'action'=>'delete', 'resume_id'=>$resume->getIdentity()), $this->translate('Delete Resume'), array('class'=>'buttonlink icon_resume_delete'))?>
                <?php endif; ?>
              </div>
            </div>
          </li>
