  ...
  var up = new FancyUpload2($('demo-status'), $('demo-list'), { // options object
    ...
    onFileRemove: function(file) {
      ...
      request = new Request.JSON({
         'format' : 'json',
         'url' : '<?php echo $this->url(Array('controller' => 'attachment', 'action'=>'delete'), 'resume_extended', true) ?>',
         'data': {
...
<div id="demo-status" class="hide">
  <div>
    <?php echo $this->translate('Click "Add Attachments" to select one or more files from your computer. After you have selected the files, they will begin to upload right away. When your upload is finished, click the button below your attachment list to save them to your folder.');?>
  </div>
  <div>
    <a class="buttonlink icon_photos_new" href="javascript:void(0);" id="demo-browse"><?php echo $this->translate('Add Attachments');?></a>
