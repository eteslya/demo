...
<p><?php echo $this->translate('Your members will be asked to provide some information about their resumes when creating a new resume. Create some resume questions that allow them to provide more detailed resumes in a way that relates to the theme of your community. To reorder the resume questions, click on their names and drag them up or down.'); ?>
</p>
