  ...
  <?php
    ...
    $themes = array();
      ...
      if( APPLICATION_ENV != 'development' ) {
        $this->headLink()
          ->prependStylesheet($staticBaseUrl . 'application/modules/Resume/externals/styles/print.css', 'screen, print');
      } else {
        $this->headLink()
          ->prependStylesheet(rtrim($this->baseUrl(), '/') . '/application/modules/Resume/externals/styles/print.css', 'screen, print');
      }
