 ...
 * @license    http://www.socialengine.net/license/
 */
class Resume_Model_Photo extends Core_Model_Item_Collectible
{
  protected $_parent_type = 'resume_album';

  protected $_owner_type = 'user';
  
  protected $_collection_type = 'resume_album';
  ...
  public function getHref($params = array())
  {
    $params = array_merge(array(
      ...
      'controller' => 'photo',
      'action' => 'view',
      'resume_id' => $this->getCollection()->getOwner()->getIdentity(),
  ...
  public function getResume()
  {
    ...
    //return $this->getCollection()->getResume();
  }
  ...
  {
    // Resume_Model_Resume  = $this->getParent()->getParent();
