...
class Resume_Form_Admin_Resume_Package extends Engine_Form
{

  public function init()
  {
    $this->setTitle('Update Resume Package')
      ->setDescription("To change a resume's package to another one, just select the new package you would to assign the resume to.")
    ...
    $this->addElement('Select', 'package_id', array(
      ...
      'allowEmpty' => false,
      'required' => true,
      'multiOptions' => Engine_Api::_()->resume()->getPackageOptions(),
    ));
