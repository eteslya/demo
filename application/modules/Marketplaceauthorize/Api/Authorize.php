...
class Marketplaceauthorize_Api_Authorize extends Marketplaceauthorize_Api_PaymentGateway
{
    /**
	...
	public function __construct()
	{
		...
		$this->ipnLogFile = APPLICATION_PATH . '/temporary/log/authorize.ipn_results.log';
    ...
    public function prepareSubmit()
    {
		...
		$this->addField('x_recurring_billing', true); //et
		$this->addField('x_subscription_paynum', 1); //et
