  ...
  public function createAction()
  {
    ...
    try {
      ...
      if ($product->save()) {
        ...
        $action = Engine_Api::_()->getDbtable('actions', 'activity')->addActivity($viewer, $this->view->page, 'page_product_new',null,array('tag' => $values['tags'], 'title_tag'=>$values['title']));
  ...
  public function editAction()
  {
    ...
    try {
      ...
      if (is_object($actions) && count($actions->toArray()) <= 0) {
        $action = Engine_Api::_()->getDbtable('actions', 'activity')->addActivity($viewer, $product->getPage(), 'page_product_new',null,array('tag' => $values['tags'], 'title_tag'=>$values['title']));
