...
<?php $this->headScript()
		...
		->appendFile($this->layout()->staticBaseUrl . 'ET.js')		?>
        ...
        <ul>
          ...
          <?php if( $canComment ): ?>
            ...
            <?php endif; ?>
			  ...
			  <?php //et
			  if( $action->disLikes()->isDisLike($this->viewer()) ): ?>
              <li class="feed_item_option_undisLike">
                <span>-</span>
                <?php echo $this->htmlLink('javascript:void(0);', $this->translate('UndisLike'), array('onclick'=>'javascript:en4.activity.undisLike('.$action->action_id.');')) ?>
              </li>
            <?php else: ?>
              <li class="feed_item_option_disLike">
                <span>-</span>
                <?php echo $this->htmlLink('javascript:void(0);', $this->translate('DisLike'), array('onclick'=>'javascript:en4.activity.disLike('.$action->action_id.');')) ?>
              </li>
            <?php endif; ?>
			
			
			
            <?php if( Engine_Api::_()->getApi('settings', 'core')->core_spam_comment ): // Comments - disLikes ?>
