...
class Groupbuy_Form_Admin_Global extends Engine_Form
{
  public function init()
  {
    ...
    $this
      ...
      $this->addElement('Radio', 'groupbuy_mode', array(
        'label' => '*Enable Test Mode?',
        'description' => 'Allow admin to test Group Buy by using development mode? ',
        'multiOptions' => array(
          1 => 'Yes',
          0 => 'No'
        ),
        'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('groupbuy.mode', 0),
      ));
