...
if (!$account):
   ...
   <div>
   <?php echo $this->translate('Seller Account Management.'); ?><span><a href="<?php echo $this->url(array('action' => 'transaction'),'groupbuy_general'); ?>"> <?php echo $this->translate('View my transaction history'); ?></a></span><br />
   </div>
                  ...
                  <form method="post" action="<?php echo $this->url(array('action'=>'edit'),'groupbuy_account'); ?>">
                     <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr style="background:#E9F4FA none repeat scroll 0 0;">
                           <th align="center" style="padding-top: 5px;padding-bottom: 5px;color:#717171;"><?php echo $this->translate('User Information'); ?></th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           <td class="ynaffiliate_account">
                              <span class="ynaffiliate_account_bold"><?php echo $this->translate('Status'); ?></span>: <?php if ($info_user['status'] != ''): echo $info_user['status'];
                     else: echo $this->translate('Not update');
                     endif; ?>
                           </td>
                        </tr>
   <?php if ($account):
   ...
   <?php endif; ?>
               ...
               <div align = "left" style="padding-left:10px;" id="message_request_<?php echo $this->info_user['user_id'] ?>">
               </div>
