...
<div class="groubuy_baselevel groupbuy_normallevel">
<div class="item" id ="itemindex<?php echo $index; ?>">
<div class="groupbuy_bb1">
<div class="groupbuy_bb2">
<div class="groupbuy_bb3">
...
<span style="<?php if($data->bold == 1): ?>font-weight: bold;<?php endif;?><?php if($data->italic == 1): ?>font-style: italic;<?php endif;?><?php if($data->highlight == 1): ?>background-color: yellow;<?php endif;?>"><?php echo $this->htmlLink($data->getHref(), $data->getTitle()) ?> </span>
 ...
 <?php $fullname = substr($data->getOwner()->getTitle(), 0, 15);
  if (strlen($data->getOwner()->getTitle())>15): $fullname = $fullname."..."; endif; ?>
...
function update(index) {
    ...
    { 
        ...
        up<?php echo $index?> = setTimeout("update(<?php echo $index?>)",5000);   
    }  
        ...
        else
        {
	 	   ...
	 	   if(flagc<?php echo $index ?> == true)
           {
	 	    ...
	 	    if((mins<?php echo $index ?> == 0) && (secs<?php echo $index ?> == 0) && flagc<?php echo $index ?> == false) 
			{
                ...
                clearTimeout(cd<?php echo $index ?>);
                $('btn<?php echo $index ?>').innerHTML = '<div class="active" style="background-position: 0 -160px"><?php echo $this->translate('Won');?></div>';   
...
window.onload = init;
 ...
 <br/>
<div>
 <?php echo $this->paginationControl($this->homeres, null, array("pagination/auctionpagination.tpl","auction"), array()); ?>
</div>
...
window.addEvent('domready',function(){
    $$('ul.groupbuy_list li:nth-child(3n+1)').setStyle('margin','0px 0px 10px 0px');
});
</script>