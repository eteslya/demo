...
class Groupbuy_IndexController extends Core_Controller_Action_Standard
{
  ...
  public function init()
  {
    ...
    ->appendFile($this->view->baseUrl().'/application/modules/Groupbuy/externals/scripts/core.js');
    $this->view->headScript()
  ...
  public function browseAction()
  {
      ...
      ->getNavigation('groupbuy_main', array(), 'groupbuy_main_browse');
      $array = $this->getRequest()->getPost();
      $subject = Engine_Api::_()->getItem('groupbuy_param', 1);
      $subject->search =$subject->category = $subject->location = "";
      $subject->status = "Running";
      $subject->orderby = 'featured'; 
      $subject->save();
      ...
      if($array)
       {
               ...
               if(isset($array['location']))
                   $subject->location = $array['location'];               
               else
                   $subject->location = "";
                   
               if(isset($array['status']))
                   $subject->status = $array['status'];               
               else
                   $subject->status = "";
  ...
  public function listingAction()
  {
    ...
    $subject = Engine_Api::_()->getItem('groupbuy_param', 1);
    $subject->search = $subject->orderby =$subject->category = $subject->location= "";              $subject->status = "30";
    ...
    if($array)
       ...
       if(isset($request['orderby'])) {
                   $subject->orderby = $request['orderby'];
                       $subject->save();
       }    
  ...
  public function deliveryAction() {
    ...
    try
    {
        $ttvalues = array('transaction_date' => date('Y-m-d H:i:s'),
                          'user_seller' => $deal->user_id,
                          'user_buyer' => $viewer->getIdentity(),
                          'item_id' => $deal_id,
                          'amount' => $total_amount,
                          'account_seller_id' => Groupbuy_Api_Cart::getFinanceAccount($deal->user_id,2),
                          'account_buyer_id' => Groupbuy_Api_Cart::getFinanceAccount($viewer->getIdentity(),2),
                          'number' => $number,
                          'transaction_status' => '1',
                          'params' => 'Cash on Delivery',
        );
    ...
    try
    {
        $bdvalues = array('item_id' => $deal_id,
  ...
  {  
    ...
    //create bill
    $bill =  Groupbuy_Api_Cart::makeBillFromCart($deal,$receiver[0],1,$numbers); 
    //update status bill
    $bill->bill_status = 1;
    $bill->save();
    $viewer = Engine_Api::_()->user()->getViewer();    
    ...
    try
    {
        ...
        $ttvalues = array('transaction_date' => date('Y-m-d H:i:s'),
                          ...
                          'account_buyer_id' => $account_buyer['paymentaccount_id'],
                          'number' => $numbers,
                          'transaction_status' => '1',
                          'params' => 'Buy deal by virtual money',
        );
        $ttrow = $tttable->createRow();
        $ttrow->setFromArray($ttvalues);
        $ttrow->save();
  ...
  public function createAction()
  {
     // Check auth
    if( !$this->_helper->requireUser()->isValid() ) return;
    if( !$this->_helper->requireAuth()->setAuthParams('groupbuy_deal', null, 'create')->isValid()) return;
    // Get navigation
     $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
          ->getNavigation('groupbuy_main');
  ...
  if ($allow_payment == 0) {
    ...
    try
    {
     ...
     // }
      ...
      $dealtable->update(array(
                'deal_href' => $deal->getHref(),
                  ), array(
  ...
  public function successAction()
  {
    ...
    // Get navigation
    $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
      ->getNavigation('groupbuy_main', array(), 'groupbuy_main_manage');
  ...
  public function editAction()
  {
     ...
     // Get navigation
     $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
          ->getNavigation('groupbuy_main', array(), 'groupbuy_main_managedeal');
    $viewer = $this->_helper->api()->user()->getViewer();
    $deal = Engine_Api::_()->getItem('deal', $this->_getParam('deal'));
    ...
    if( !$this->_helper->requireAuth()->setAuthParams($deal, $viewer, 'edit')->isValid() ) 
        return;
    // Prepare form
    $this->view->form = $form = new Groupbuy_Form_Edit(array(
      'item' => $deal
    ));
    $user_id = Engine_Api::_()->user()->getViewer()->getIdentity();
    $info = Groupbuy_Api_Account::getCurrentInfo($user_id); 
  ...
  public function deleteAction()
  {
    ...
    try {
      ...
      $this->_forward('success', 'utility', 'core', array(
                  ...
                  'parentRefresh' => true,
                  'format'=> 'smoothbox',
                  'messages' => array('Delete deal successfully.')
                  ));
    } catch (Exception $e) {
      $db->rollback();
   ...
   public function manageSellingAction()
  {
    ...
    if( !$this->_helper->requireUser()->isValid() ) return;
    $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
          ->getNavigation('groupbuy_main', array(), 'groupbuy_main_manage-selling');
    // Get quick navigation
    $this->view->quickNavigation = $quickNavigation = Engine_Api::_()->getApi('menus', 'core')
      ->getNavigation('groupbuy_quick');
   ...
   public function manageBuyingAction()
  {
    ...
    if( !$this->_helper->requireUser()->isValid() ) return;
    $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
          ->getNavigation('groupbuy_main', array(), 'groupbuy_main_manage-buying');
    // Get quick navigation
    $this->view->quickNavigation = $quickNavigation = Engine_Api::_()->getApi('menus', 'core')
      ->getNavigation('groupbuy_quick');
        $form = new Groupbuy_Form_Search();
    $form->setAction(Zend_Controller_Front::getInstance()->getRouter()->assemble(array(
          'action' => 'manage-buying',
        ), 'groupbuy_general',true));
    $this->view->form = $form;
    $form->status->clearMultiOptions();
  ...
  {  
      if (!$this->_helper->requireUser()->isValid()) { return;}
       ...
       $cancelUrl = Zend_Controller_Front::getInstance()->getRouter()->assemble($params, 'groupbuy_general', true);
       $_SESSION['url']['cancel'] = $cancelUrl;
       $returnUrl = $this->selfURL().'application/modules/Groupbuy/externals/scripts/redirect1.php?pstatus=success&req4='.$_SESSION['payment_sercurity'].'&req5=';
       $cancelUrl = $this->selfURL().'application/modules/Groupbuy/externals/scripts/redirect1.php?pstatus=cancel&req4='.$_SESSION['payment_sercurity'].'&req5=';
       $notifyUrl = $this->selfURL().'application/modules/Groupbuy/externals/scripts/callback1.php?action=callback&req4='.$_SESSION['payment_sercurity'].'&req5=';
  ...
  public function stopAction()
  {
          ...
          $this->_forward('success', 'utility', 'core', array(
                  ...
                  'parentRefresh' => true,
                  'format'=> 'smoothbox',
                  'messages' => array('Stop deal successfully.')
                  ));
  }
  public function startAction()
  {
          ...
          $this->_forward('success', 'utility', 'core', array(
                  ...
                  'parentRefresh' => true,
                  'format'=> 'smoothbox',
                  'messages' => array('Start deal successfully.')
                  ));
  }
  public function approveAction()
  {
          ...
          $this->_forward('success', 'utility', 'core', array(
                  ...
                  'parentRefresh' => true,
                  'format'=> 'smoothbox',
                  'messages' => array('Approve deal successfully.')
                  ));
  }
   public function denyAction()
  {
          ...
          $this->_forward('success', 'utility', 'core', array(
                  ...
                  'parentRefresh' => true,
                  'format'=> 'smoothbox',
                  'messages' => array('Deny deal successfully.')
                  ));
  }
   public function reopenAction()
  {
          ...
          $this->_forward('success', 'utility', 'core', array(
                  ...
                  'parentRefresh' => true,
                  'format'=> 'smoothbox',
                  'messages' => array('Re-Open deal successfully.')
                  ));
  }
  ...
  public function editcouponAction()
  {
          ...
          if ($dealresult->user_id != $viewer->getIdentity()) {
            ...
            'smoothboxClose' => 10,
            'parentRefresh' => 10,
                'messages' => array('You cannot change this coupon code!')
            ));
          }
          else {
              $table->update(array(
            ...
            'smoothboxClose' => 10,
            'parentRefresh' => 10,
                'messages' => array('Coupon Code Status Changed Successfully!')
            ));
          }
  ...
  {  
    ...
    try
    {
        $ttvalues = array('transaction_date' => date('Y-m-d H:i:s'),
                          ...
                          'currency' => $bill->currency,
                          'amount' => $bill->amount,
                          'account_seller_id' => Groupbuy_Api_Cart::getFinanceAccount($bill->owner_id,1),
                          'account_buyer_id' => Groupbuy_Api_Cart::getFinanceAccount($viewer->getIdentity(),2),
                          'number' => 1,
                          'transaction_status' => '1',
                          'params' => 'Pay publishing fee by virtual money',
        );
        $ttrow = $tttable->createRow();
        $ttrow->setFromArray($ttvalues);
        $ttrow->save();
  ...
  public function deleteBuyAction()
  {
    ...
    try {
      ...
      $this->_forward('success', 'utility', 'core', array(
                  ...
                  'parentRefresh' => true,
                  'format'=> 'smoothbox',
                  'messages' => array('Delete item successfully.')
                  ));
    } catch (Exception $e) {
      $db->rollback();
      $this->view->success = false;
  ...
  {  
      ...
      if (!$this->_helper->requireUser()->isValid()) { return;}
       ...
       $cancelUrl = Zend_Controller_Front::getInstance()->getRouter()->assemble($params, 'groupbuy_general', true);
       $_SESSION['url']['cancel'] = $cancelUrl;
       $returnUrl = $this->selfURL().'application/modules/Groupbuy/externals/scripts/redirect.php?pstatus=success&gift_id='.$gift_id.'&req4='.$_SESSION['payment_sercurity'].'&req5=';
       $cancelUrl = $this->selfURL().'application/modules/Groupbuy/externals/scripts/redirect.php?pstatus=cancel&gift_id='.$gift_id.'&req4='.$_SESSION['payment_sercurity'].'&req5=';
       $notifyUrl = $this->selfURL().'application/modules/Groupbuy/externals/scripts/callback.php?action=callback&gift_id='.$gift_id.'&req4='.$_SESSION['payment_sercurity'].'&req5=';
       list($receiver,$paramsPay) = Groupbuy_Api_Cart::getParamsPay($gateway_name,$returnUrl,$cancelUrl,$method_payment,$notifyUrl);
       $_SESSION['receiver'] = $receiver;
       $method_payment = 'directly';
       $paymentForm = "https://www.sandbox.paypal.com/cgi-bin/webscr";
    ...
    public function buygiftAction() {
        ...
        if (($this->_getParam('method')) && $this->_getParam('method') == 2) {
          ...
          'action' => 'buy-deal',
           ...
           'format'=> 'smoothbox',
           'messages' => array("This deal does not support Buy For Friend!")
        ));
        }
        else {
 ...
 public function editgiftAction() {
    ...
    public function deletegiftAction(){
        ...
        $this->_forward('success', 'utility', 'core', array(
          ...
          'action' => 'buy-deal',
           ...
           'format'=> 'smoothbox',
           'messages' => array('Cancel successfully.')
        ));
    }
  public function adminEditAction()
  {
       $viewer = $this->_helper->api()->user()->getViewer();
     if( !$this->_helper->requireUser()->isValid() || $viewer->level_id > 2 ) return;
     // Get navigation
     $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
          ->getNavigation('groupbuy_main', array(), 'groupbuy_main_managedeal');
    $deal = Engine_Api::_()->getItem('deal', $this->_getParam('deal'));
   ...
   public function updateAction()
  {
          ...
          $this->_forward('success', 'utility', 'core', array(
            'smoothboxClose' => 10,
            'parentRefresh' => 10,
                'messages' => array('Your Changed Successfully!')
            ));
  }  
}
