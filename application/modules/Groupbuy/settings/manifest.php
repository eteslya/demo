   ...
   // Routes --------------------------------------------------------------------
    'routes' => array(
        ...
        'groupbuy_general' => array(
            ...
            'reqs' => array(
                'action' => '(browse|create|success|edit|admin-edit|delete|detail|rate|publish|publish-free|manage-selling|manage-buying|stop|start|transaction|history|userdeal|approve|deny|listing|email|request|request-refund|delete-buy|contract|buy-deal|delivery|statistic|reopen|buydeals|buygift|editgift|deletegift|editcoupon|accountmoney|publishmoney)',
            ),
        ),
        'groupbuy_cron' => array(
