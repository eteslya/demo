...
('groupbuy', 'Group Buy', 'This is Group Buy module.', '4.03p7', 1, 'extra');
...
('groupbuy_admin_main_paymentsettings', 'groupbuy', 'Gateway', '', '{"route":"admin_default","module":"groupbuy","controller":"payment"}', 'groupbuy_admin_main', '', 12),
('groupbuy_admin_main_fields', 'groupbuy', 'Questions', '', '{"route":"admin_default","module":"groupbuy","controller":"fields"}', 'groupbuy_admin_main', '', 13),
...
--
-- Table structure for table `engine4_groupbuy_gateways`
--

CREATE TABLE IF NOT EXISTS `engine4_groupbuy_gateways` (
...
--
-- Dumping data for table `engine4_groupbuy_gateways`
--
...
--
-- Table structure for table `engine4_groupbuy_params`
--

CREATE TABLE IF NOT EXISTS `engine4_groupbuy_params` (
...
INSERT INTO `engine4_groupbuy_params` (`param_id`, `featured`, `location`, `search`, `orderby`, `status`, `category`, `start_time`, `end_time`, `page`) VALUES (1, 0, 0, NULL, '', NULL, NULL, '', '', NULL);
--
-- Dumping data for table `engine4_groupbuy_params`
--
...
((SELECT `page_id` FROM `engine4_core_pages` WHERE `name`='groupbuy_index_listing'),'widget','groupbuy.search-deals',(SELECT LAST_INSERT_ID() + 1),4,'{"title":"Search Deals"}',NULL);
...
((SELECT `page_id` FROM `engine4_core_pages` WHERE `name`='groupbuy_index_listing'),'widget','groupbuy.search-listing-deals',(SELECT LAST_INSERT_ID() + 1),6,NULL,NULL);
...
INSERT INTO `engine4_groupbuy_gateways` (`gateway_id`, `gateway_name`, `admin_account`, `is_active`, `params`) VALUES
(1, 'Paypal', '', 1, ''),
(2, '2Checkout', '', 0, '');