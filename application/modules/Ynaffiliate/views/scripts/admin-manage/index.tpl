...
<script type="text/javascript">
   en4.core.runonce.add(function(){
      $$('th.admin_table_short input[type=checkbox]').addEvent('click', function(){ $$('td.checksub input[type=checkbox]').set('checked', $(this).get('checked', false)); })});
...
<?php else: ?>
   <div class="tip">
      <span>
         <?php echo $this->translate("There are no affiliate yet.") ?>
      </span>
   </div>
<?php endif; ?>
