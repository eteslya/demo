      ...
      <?php foreach( $this->paginator as $item ): ?>
        <li>
          <div class='marketplaces_browse_photo'>
			...
			<?php echo $this->htmlLink($item->getHref(), $this->htmlImage($item->getChannelTypeURL2($item->getHref2()))); ?>
          </div>
...
<div class='marketplaces_browse_info_blurb'>
              <span style="font-weight:bold;font-size:12px;">Price:</span> <span style="font-size:12px;"><?php echo Engine_Api::_()->marketplace()->getCurrencySign().$item->price; ?></span>
              <br />
              <?php
                // Not mbstring compat
