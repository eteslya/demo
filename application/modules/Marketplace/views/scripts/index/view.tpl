			  ...
			  <div class="marketplace_entrylist_entry_date">
				...
				<ul class='marketplace_thumbs'>
				  <?php $i=0; foreach( $this->paginator as $photo ): ?>
					...
					<?php $i++;endif;?>
				  <?php endforeach;?>
				  <?php if ((count($i) % 4) != 0): ?></li> <?php endif;?>
				</ul>
		  ...
		  <div class="marketplace_fieldvalueloop">
			...
			<ul style="margin:15px 0;">
				<li>
					...
					<span style="font-size:18px;"><?php echo Engine_Api::_()->marketplace()->getCurrencySign().(($this->marketplace->price - $this->discount_sum) >= 0?$this->marketplace->price - $this->discount_sum:0);?></span>
				</li>
				<?php if(Engine_Api::_()->marketplace()->upsIsActive()): ?>
					...
					<?php if($product_shipping_fee): ?>
						<li>
							...
							<span style="font-size:13px;"><?php echo Engine_Api::_()->marketplace()->getCurrencySign().number_format($product_shipping_fee, 2);?></span>
						</li>
					<?php endif; ?>
				<?php endif; ?>
			</ul>
