...
var Milkbox = new Class({
	...
	prepareHTML:function(){		
		...
		this.center = new Element('div', {'id':'mbCenter', 'styles':{'width':this.options.initialWidth,'height':0,'marginLeft':-(this.options.initialWidth/2),'opacity':0 }}).inject($(document.body));
	...
	closeMilkbox:function(){
   	...
   	this.canvas.setStyles({'opacity':0, 'width':'', 'height':''});
		...
		this.center.setStyles({'opacity':0,'width':this.options.initialWidth,'height':0,'marginLeft':-(this.options.initialWidth/2)});
