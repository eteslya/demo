...
class Page_Form_Admin_Global extends Engine_Form
{
  public function init()
  {
    ...
    */
    ...
    $this->addElement('Radio', 'public_mode', array(
      'label' => 'Public Mode',
      'description' => 'Allow public users to view pages',
      'multiOptions' => array(
        '0' => 'Not allowed',
        '1' => 'Allowed',
      ),
      'value' => $settings->getSetting('page.public.mode', 'list'),
    ));


    $this->addElement('Radio', 'show_owner', array(
      'label' => 'Show owners',
      'description' => 'Allow to show owners of pages',
      'multiOptions' => array(
        '0' => 'Do not show',
        '1' => 'Show',
      ),
      'value' => $settings->getSetting('page.show.owner', 'list'),
    ));
