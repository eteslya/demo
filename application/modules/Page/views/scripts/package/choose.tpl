...
<div class="package-list-layout">
	<div>
		<div class="package-list-description">
			<h3>
			Subscribe To Any Channel Package
			</h3>
			
			<p>
				Please select the package which fits your Channel needs and just click on `Continue` button to go ahead.
			</p>
		</div>
    ...
    <div class="package_list">
      ...
      <div class="package_description"> <?php echo $package->description; ?> </div>
        <form action="<?php echo $this->url(); ?>" method="post">
          <input type="hidden" name="package_id" value="<?php echo $package->getIdentity(); ?>"/>
          <button type="submit" class="payButtom" style="color:#fff; cursor:pointer"><?php echo $this->translate('Continue') .'&nbsp;&raquo';?> </button>
        </form>
      </div>
    </div>
    <?php endforeach;?>
