...
<?php if($this->page && $this->page->getIdentity()): ?>
...
<?php else : ?>
  <?php echo $this->translate('Your payment has been cancelled and not been charged. If this is not correct, please try again later.');?>
<?php endif;?>