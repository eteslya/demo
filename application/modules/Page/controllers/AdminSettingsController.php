...
class Page_AdminSettingsController extends Core_Controller_Action_Admin
{
	...
	public function indexAction()
  {
    ...
    $settings->setSetting('page.browse_count', $value);
  	...
  	$value = $form->getValue('public_mode');
    $settings->setSetting('page.public_mode', $value);
  	$form->public_mode->setValue($value);

  	$value = $form->getValue('show_owner');
    $settings->setSetting('page.show_owner', $value);
  	$form->public_mode->setValue($value);
