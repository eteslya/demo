...
function fOwner(arg)
{
	...
	//document.getElementById("global_content").innerHTML = '<iframe id="body" name="body" src="'+arg+'" frameborder="0" scrolling="no" align="top" height="708" width="798"></iframe>';
        ...
        <div class="page_list_item_photo <?php  if($page->featured) echo 'featured_page' ?>">
		  ...
		  { 
					...
					if($page->getChannelTypeURL($page_id) != '0')
					{
						...
						<div style="margin: 1px 0 1px 20px; padding:2px; color:#fff; text-align:center; width: 105px; background-color:#2D363F; cursor:pointer" onclick="fOwner('<?php echo $page->getChannelOwner($page_id) ?>');" style="color:#fff">Owner Info</div>
							...
							{?>
								...
								<a href="/bv/login" target="_parent" style="border: none; margin:0; padding:0"><div style="margin: 1px 0 1px 20px; padding:2px; color:#fff; text-align:center; width: 105px; background-color:#2D363F; cursor:pointer" target="global_content" style="color:#fff">Sign In</div></a>
								...
								{
								?>
								<div style="margin: 1px 0 28px 20px; padding:2px; color:#fff; text-align:center; width: 105px; background-color:#2D363F; cursor:pointer" onclick="fSub('<?php echo $page->getChannelTypeURL($page_id); ?>', '<?php echo $page->getTitle(); ?>');" target="global_content" style="color:#fff">Subscribe</div>
								<?php
		  ...
		  {
			?>
		  <div style="margin: 2px 0 0 20px; padding:5px; color:#fff; text-align:center; width: 105px; background-color:#2D363F; cursor:pointer" onclick="fSub('<?php echo $page->getChannelTypeUnsub($page_id); ?>', '<?php echo $page->getTitle(); ?>');" target="global_content" style="color:#fff">UnSubscribe</div>
		  <?php
		  }
		  ?>
