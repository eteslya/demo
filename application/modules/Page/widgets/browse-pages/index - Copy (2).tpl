      ...
      <li class="<?php if($page->sponsored) echo 'page_list_item_sponsored' ?> <?php echo $classBackgroundColor; ?>" >
        ...
        <div class="page_list_item_photo <?php  if($page->featured) echo 'featured_page' ?>">
		  ...
		  { 
			...
			<div style="margin: 2px 0 2px 20px; padding:5px; color:#fff; text-align:center; width: 105px; background-color:#2D363F; cursor:pointer" onclick="fSub('<?php echo $page->getChannelTypeURL($page_id); ?>');" target="global_content" style="color:#fff">Subscribe</div>
		  ...
		  { ?>
		  <div style="margin: 2px 0 0 20px; padding:5px; color:#fff; text-align:center; width: 105px; background-color:#2D363F; cursor:pointer" onclick="fSub('<?php echo $page->getChannelTypeUnsub($page_id); ?>');" target="global_content" style="color:#fff">UnSubscribe</div>
		  <?php
		  }
		  ?>
