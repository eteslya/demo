    ...
    <?php foreach( $this->paginator as $page ): ?>
      ...
      <li class="<?php if($page->sponsored) echo 'page_list_item_sponsored' ?> <?php echo $classBackgroundColor; ?>" >
        ...
        <div class="page_list_item_photo <?php  if($page->featured) echo 'featured_page' ?>">
		  ...
		  ?>
		<div style="margin: 2px 0 0 20px; padding:5px; color:#fff; text-align:center; width: 105px; background-color:#2D363F; cursor:pointer" onclick='alert(<?php echo $page_id; ?> + " : " +   <?php //echo $this->subject->getWebsite();?>);'>Subscribe</div>
