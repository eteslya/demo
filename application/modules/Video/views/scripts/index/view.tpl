 ...
 * @version    $Id: view.tpl 10030 2013-03-28 23:06:59Z jung $
 * @author     Jung
 */
?>
...
<div class="video_view video_view_container">
  ...
  <?php else: ?>
  <div class="video_embed test2">
  
	<?php $test = str_replace("http:", "https:", $this->videoEmbedded); ?>
    <?php echo "<script>//alert('".strrpos($test, "http")."');</script>"; ?>
	<?php echo str_replace("http:", "https:", $this->videoEmbedded); ?>
  </div>
  <?php endif; ?>
