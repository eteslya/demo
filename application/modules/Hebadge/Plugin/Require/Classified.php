 ...
 * @version    $Id: Classified.php 02.04.12 09:12 michael $
 * @author     Michael
 */
...
class Hebadge_Plugin_Require_Classified extends Hebadge_Plugin_Require_Abstract
{
  ...
  public function getCount(Core_Model_Item_Abstract $owner, $new_item_id = null)
  {
    ...
    if (!empty($new_item_id)){
      $select->where('classified_id != ?', $new_item_id);
    }
