...
class Hebadge_Form_Admin_PageBadge_Create extends Engine_Form
{
  ...
  public function init()
  {
    ...
    $this->setTitle('HEBADGE_FORM_ADMIN_PAGEBADGE_CREATE_TITLE');
    $this->setDescription('HEBADGE_FORM_ADMIN_PAGEBADGE_CREATE_DESCRIPTION');
...
/*
    ...
    $this->getElement('photo')->addDecorator('HebadgePagePhoto');
    $this->getElement('icon')->addDecorator('HebadgePagePhoto');
