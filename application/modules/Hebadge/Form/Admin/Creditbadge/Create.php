...
class Hebadge_Form_Admin_CreditBadge_Create extends Engine_Form
{
  ...
  public function init()
  {
    ...
    $this->setTitle('HEBADGE_FORM_ADMIN_CREDITBADGE_CREATE_TITLE');
    $this->setDescription('HEBADGE_FORM_ADMIN_CREDITBADGE_CREATE_DESCRIPTION');
...
/*
    ...
    $this->getElement('photo')->addDecorator('HebadgeCreditPhoto');
    $this->getElement('icon')->addDecorator('HebadgeCreditPhoto');

    $this->addElement('text', 'credit', array('label' => 'HEBADGE_FORM_ADMIN_CREDITBADGE_LABEL_CREDIT'));
