        ...
        <tbody>
          <?php foreach ($this->paginator as $item):?>
            <tr>
              ...
              <td>
                <a href="<?php echo $this->url(array('module' => 'hebadge', 'controller' => 'badges', 'action' => 'edit', 'badge_id' => $item->getIdentity()), 'admin_default', true);?>"><?php echo $this->translate('Edit');?></a>&nbsp;|&nbsp;<a class="smoothbox" href="<?php echo $this->url(array('module' => 'hebadge', 'controller' => 'badges', 'action' => 'remove', 'badge_id' => $item->getIdentity()), 'admin_default', true);?>"><?php echo $this->translate('Delete');?></a>
              </td>
            </tr>
          <?php endforeach; ?>
        </tbody>
