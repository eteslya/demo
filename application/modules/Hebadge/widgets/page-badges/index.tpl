...
<div class="hebadge_widget_description">
  <?php echo $this->translate('HEBADGE_WIDGET_DESCRIPTION_PROFILE_PAGE_BADGES');?>
</div>
...
<?php else:?>
  ...
  <div class="tip"><span><?php echo $this->translate('HEBADGE_WIDGET_NOITEMS_PROFILE_PAGE_BADGES');?></span></div>
...
<?php if ($this->paginator->count() > 1): ?>
  <?php echo $this->paginationControl($this->paginator, null, array("pagination.tpl","hebadge"), array(
    'ajax_url' => $this->url(array('module' => 'core', 'controller' => 'widget', 'action' => 'index', 'name' => 'hebadge.page-badges', 'subject' => $this->subject()->getGuid()), 'default', true),
    'ajax_class' => 'layout_hebadge_page_badges'
  ))?>
  <br />
<?php endif?>