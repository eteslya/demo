...
class Hebadge_Widget_BadgesFriendController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
    ...
    $this->view->paginator = $paginator = $table->getFriendMemberPaginator($viewer, $params);
    ...
    $this->view->items = Engine_Api::_()->hebadge()->getTableItems($table, $ids);
