...
class Pagevideo_Model_DbTable_Pagevideos extends Engine_Db_Table
{
  ...
  public function getVideoFileInfo($video)
  {
    ...
    if ($video->type == 1){
      $data['width'] = 560;
      $data['height'] = 340;
      $data['url'] = "https://www.youtube.com/v/".$video->code."&color1=0xb1b1b1&color2=0xcfcfcf&hl=en_US&feature=player_embedded&fs=1";
      $data['player'] = "https://www.youtube.com/v/".$video->code."&color1=0xb1b1b1&color2=0xcfcfcf&hl=en_US&feature=player_embedded&fs=1";
    }

    if ($video->type == 2){
      $data['width'] = 640;
      $data['height'] = 360;
      $data['url'] = "https://vimeo.com/moogaloop.swf?clip_id=".$video->code."&server=vimeo.com&show_title=1&show_byline=1&show_portrait=0&color=&fullscreen=1";
      $data['player'] = "https://vimeo.com/moogaloop.swf?clip_id=".$video->code."&server=vimeo.com&show_title=1&show_byline=1&show_portrait=0&color=&fullscreen=1";
    }
