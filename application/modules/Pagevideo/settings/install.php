 ...
 * @version    $Id: install.php 2010-09-20 16:05 idris $
 * @author     Idris
 */
...
class Pagevideo_Installer extends Engine_Package_Installer_Module
{
  public function onPreInstall()
  {
    ...
    if (version_compare($hecore['version'], '4.1.5') < 0) {
