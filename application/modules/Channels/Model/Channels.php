 ...
 * @version    $Id: Channels.php 9747 2012-07-26 02:08:08Z john $
 * @author     Jung
 */
 ...
 * @license    http://www.socialengine.com/license/
 */
class Channels_Model_Channels extends Core_Model_Item_Abstract
{
  // Properties
  ...
  public function setPhoto($photo)
  {
    if( $photo instanceof Zend_Form_Element_File ) {
      ...
      throw new Channels_Model_Exception('invalid argument passed to setPhoto');
    }
    ...
    $photoTable = Engine_Api::_()->getItemTable('channels_photo');
    $channelsAlbum = $this->getSingletonAlbum();
    $photoItem = $photoTable->createRow();
    $photoItem->setFromArray(array(
      'channels_id' => $this->getIdentity(),
      'album_id' => $channelsAlbum->getIdentity(),
      'user_id' => $viewer->getIdentity(),
      'file_id' => $iMain->getIdentity(),
      'collection_id' => $channelsAlbum->getIdentity(),
    ));
    $photoItem->save();
  ...
  public function addPhoto($file_id){
    ...
    $photo = Engine_Api::_()->getDbtable('photos', 'channels')->createRow();
  ...
  {
    $table = Engine_Api::_()->getItemTable('channels_album');
    $select = $table->select()
      ->where('channels_id = ?', $this->getIdentity())
      ->order('album_id ASC')
      ->limit(1);
