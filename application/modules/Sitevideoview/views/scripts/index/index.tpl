...
<script type="text/javascript">
  ...
  <?php endif; ?>
    ...
    function getSiteviewPrevVideo(){
      en4.sitevideoview.showVideo("<?php echo $this->escape($this->prevVideo->getHref()) ?>",<?php echo json_encode(array_merge($this->params, array('offset' => $this->PrevOffset, 'is_ajax_lightbox' => 1))); ?>);
    }

    function getSiteviewNextVideo(){
      en4.sitevideoview.showVideo("<?php echo $this->escape($this->nextVideo->getHref()) ?>",<?php echo json_encode(array_merge($this->params, array('offset' => $this->NextOffset, 'is_ajax_lightbox' => 1))); ?>);
    }
    <?php endif; ?>
  </script>
