...
class Zend_Search_Lucene_Storage_File_Memory extends Zend_Search_Lucene_Storage_File
{
    ...
    public function readLong32Bit()
    {
        ...
        // Modified by Webligo Developments for IonCube compat
        return $wordHigh * (float) 4294967296 + $wordLow;
    ...
    public function writeLong32Bit($value)
    {
        ...
        if ($value < 0) {
            ...
            // Modified by Webligo Developments for IonCube compat
            $wordHigh = (int)($value/(float)4294967296);
            $wordLow  = $value - $wordHigh*(float)4294967296;
