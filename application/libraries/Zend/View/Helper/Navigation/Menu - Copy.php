                                   ...
                                   $onlyActive)
    {
        ...
        foreach ($iterator as $page) {
            ...
            if ($depth > $prevDepth) {
                // start new ul tag
                if ($ulClass && $depth ==  0) {
                    $ulClass = ' id="menu" class="menu lgray slide ' . $ulClass . '"';
                } else {
                    $ulClass = '';
                }
            ...
            // Drop-down menu custom code insertion / render li tag and page
			if ($page == 'Channels') //top menue name //et
			{
				//insert custom sub-menue items here
				$sub_menue = '<ul class="sub_menu" >	<li><a href="http://bio-views.com/profile/create_channel">Create Channel</a></li><li><a href="http://bio-views.com/channel/">Find Channel</a></li><li><a href="http://bio-views.com/channel/my-subscriptions/">My Subscription</a></li></ul>';
			}
			else
			{
				$sub_menue = '';
            ...
            $liClass = $isActive ? ' class="et_d active"' : '';
            $html .= $myIndent . '    <li' . $liClass . '>' . self::EOL
                   . $myIndent . '        ' . $this->htmlify($page) . $sub_menue . self::EOL;
