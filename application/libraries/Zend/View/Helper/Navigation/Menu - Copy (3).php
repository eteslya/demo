        ...
        foreach ($iterator as $page) {
			...
			if ($page == 'Home') //top menu name - 1st tab //et added and ad changed
			{
				...
				$sub_menu = '<ul class="sub_menu" >	
                                <li><a href="/bv/resumes/manage">My Bio-View</a></li>
                                <li><a href="/bv/members">Members</a></li>
                                <li><a href="/bv/invite">Invite People</a></li>
                                </ul>';
			}
			else if ($page == 'Notifications') //top menu name - 2nd tab //ad added
			{
				//insert custom sub-menu items here
				$sub_menu = '<ul class="sub_menu sub_menu1" >
                                <li><a href="/bv/albums">Albums</a></li>
				<li><a href="/bv/videos">Videos</a></li>
                                <li><a href="">Music</a></li>
                                <li><a href="/bv/blogs">Blogs</a></li>
                                </ul>';
			}
                        else if ($page == 'Activities') //top menu name - 3rd tab //ad added
			{
				//insert custom sub-menu items here
				$sub_menu = '<ul class="sub_menu sub_menu2" >
                                <li><a href="/bv/groups">Groups</a></li>
				<li><a href="/bv/events">Events</a></li>
                                <li><a href="">My Calendar</a></li>
                                </ul>';
			}
                        else if ($page == 'Channels') //top menu name - 4th tab //ad added
			{
				//insert custom sub-menu items here
                        ...
                        else if ($page == 'Business') //top menu name - 5th tab //ad added
			{
				...
				<li><a href="">Dashboard</a></li>
                                <li><a href="">Promoter Program</a></li>
                                </ul>';
			}                       
                        else if ($page == 'Jobs') //top menu name - 6th tab //ad added
			{
				//insert custom sub-menu items here
				$sub_menu = '<ul class="sub_menu sub_menu5" >
				<li><a href="/bv/browse-pages">Find Companies</a></li>
                                <li><a href="/bv/clasifieds">Find Jobs</a></li>
                        ...
                        else if ($page == 'STORE_Store') //top menu name - 7th tab //ad changed
			{
				...
				<li><a href="/bv/group-buy">Group Buy</a></li>
                                </ul>';
			}
                        else
			{
            ...
            $html .= $myIndent . '    <li' . $liClass . '>' . self::EOL
                   . $myIndent . '        ' . $this->htmlify($page) . $sub_menu . self::EOL;
