        ...
        foreach ($iterator as $page) {
                        ...
                        else if ($page == 'Jobs') //top menu name - 4rd tab //AD added
			{
				...
				$sub_menu = '<ul class="sub_menu sub_menu3" >
                                ...
                                <li><a href="/bv/classifieds">Find Jobs</a></li>
                        ...
                        else if ($page == 'Business') //top menu name - 5th tab //AD added
			{
				...
				$sub_menu = '<ul class="sub_menu sub_menu4" >
                                <li><a href="/bv/marketplace">Create New Channel</a></li>
                        ...
                        else if ($page == 'MarketPlace') //top menu name - 6th tab //AD added
			{
				//insert custom sub-menu items here
				$sub_menu = '<ul class="sub_menu sub_menu5" >
                                <li><a href="/bv/browse-pages">Channels</a></li>
                                <li><a href="/bv/store">Store</a></li>
                                <li><a href="/bv/group-buy">GroupBuy</a></li>
                                </ul>';
			}                      
                        else if ($page == 'STORE_Store') //top menu name - 7th tab //ad changed
			{
				//insert custom sub-menu items here  
				$sub_menu = '<ul class="sub_menu sub_menu6" >
                                <li><a href="/bv/store/products">eCommerce</a></li>
				<li><a href="/bv/group-buy">GroupBuy</a></li>
                                </ul>';
			}
                        else
			...
			if(strpos($str, "globalewallet.com") > 0)
			{
				...
				$str = '<a href="javascript:void(0)" onclick="document.forms[0].innerHTML =\' '.$s.' \';" >eWallet/I-Payout</a>';
			}
