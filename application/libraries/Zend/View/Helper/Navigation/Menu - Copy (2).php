    ...
    extends Zend_View_Helper_Navigation_HelperAbstract
{
                                   ...
                                   $onlyActive)
    {
        ...
        foreach ($iterator as $page) {
			...
			if ($page == 'Home') //top menu name //et added and ad changed
			{
			...
			else if ($page == 'STORE_Store') //top menu name //et added and ad changed
			{
				//insert custom sub-menu items here
			...
			else
			{
             ...
             // Drop-down menus for STORE Plugin, custom code insertion / render li tag and page
                        //if ($page == 'Store') //top menu name // ad added
			//{
				//insert custom sub-menu items here
			//	$sub_menu = '<ul class="sub_menu" >	
                        //     <li><a href="/bv/store/products">eCommerce</a></li>
