        ...
        foreach ($iterator as $page) {
			...
			else if ($page == 'Activities') //top menu name - 2nd tab //AD added
			{
				...
				$sub_menu = '<ul class="sub_menu sub_menu1" >
                               <li><a href="/bv/invite">Invite People</a></li> 
                               <li><a href="/bv/albums/manage">Albums</a></li>
				<li><a href="/bv/videos/manage">Videos</a></li>
                                <li><a href="/bv/blogs/manage">Blogs</a></li>
                                </ul>';
			}                          
                        else if ($page == 'Learn') //top menu name - 3th tab //AD added
			{
				...
				<li><a href="/bv/browse-pages">Find Channels</a></li>
                                </ul>';
			}
                        else if ($page == 'Jobs') //top menu name - 4rd tab //AD added
			{
				...
				$sub_menu = '<ul class="sub_menu sub_menu3" >
                                <li><a href="/bv/resumes/manage">My Resume</a></li>
                                <li><a href="/bv/jobs">Find Jobs</a></li>
                                <li><a href="/bv/resumes">Seek Employees</a></li>
                                </ul>';
			}      
                        else if ($page == 'Business') //top menu name - 5th tab //AD added
			{
				...
				$sub_menu = '<ul class="sub_menu sub_menu4" >
                                <li><a href="/bv/page-package/choose/page_id/0">Create New Channel</a></li>
                                <li><a href="/bv/affiliate">Promote Bio-Views</a></li>
                                <li><a href="https://bio-views.globalewallet.com/MemberLogin.aspx" target=_new>I-Payout eWallet</a></li>
                                </ul>';
			}      
                        else if ($page == 'Store') //top menu name - 6th tab //AD changed
			{
				...
				$sub_menu = '<ul class="sub_menu sub_menu5" >
                                <li><a href="/bv/browse-pages">Channels</a></li>
                                <li><a href="/bv/store/stores">Online Stores</a></li>
				<li><a href="/bv/group-buy">GroupBuy</a></li>
                                </ul>';
			}
                        else if ($page == 'MarketPlace') //top menu name - 7th tab //AD changed
			{
				...
				$sub_menu = '<ul class="sub_menu sub_menu6" >
                                <li><a href="/bv/browse-pages">Channels</a></li>
                                <li><a href="/bv/store">Online Store</a></li>
                                <li><a href="/bv/group-buy">GroupBuy</a></li>
                                </ul>';
			}  
                        else
